...
<div class="img-row">
    <img src="https://cdn.jsdelivr.net/gh/Nanzet/nanzet-imgs/images/20201009233252.png" class="about-img" />
    <img src="https://cdn.jsdelivr.net/gh/Nanzet/nanzet-imgs/images/20201009233601.png" class="about-img" />
</div>
...
<img src="https://cdn.jsdelivr.net/gh/Nanzet/nanzet-imgs/images/20201009234523.png" class="about-img" />

&ensp;接好后连接到电脑，右击看下我的电脑【属性】--设备管理器--【端口】点开，看看有没有ch340驱动，有就可以打开软件使用了,如图：

<img src="https://cdn.jsdelivr.net/gh/Nanzet/nanzet-imgs/images/20201009234831.png" class="about-img" />
...
- [X] 第一步:检测链接【出现NFC设备】；
    <img src="https://cdn.jsdelivr.net/gh/Nanzet/nanzet-imgs/images/20201009235536.png" class="about-img" />

- [X] 第二步:将自己的卡放上后【点击扫描卡片】后【点击检测加密】（SAK值为08一般表示可解）；
    <img src="https://cdn.jsdelivr.net/gh/Nanzet/nanzet-imgs/images/20201009235757.png" class="about-img" />
...
- [X] 第六步:再把cuid卡给手环模拟，模拟成功后，再将手环放到pn532模块上【可以去除表带，放表芯背面到pn532上面】，【点击扫描卡片】，页面有显示读到手环的数据【结果要显示有数据=1才可以，=0是没扫到，需要移动位置重新扫描】，再【点击CUID写】，将第一个保存的dump文件写入直到完成即可，显示63/64块即可【原理，前面已经模拟了1块进去了，所以只需63即可】；
    ...
    <img src="https://cdn.jsdelivr.net/gh/Nanzet/nanzet-imgs/images/20201010000102.png" class="about-img" />

## 测试模拟成功

<img src="https://cdn.jsdelivr.net/gh/Nanzet/nanzet-imgs/images/20201010000225.png" class="about-img" />
